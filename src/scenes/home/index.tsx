        ...
        <motion.div 
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                >
                    ...
                    <p className="mt-8 text-sm">Elevate your fitness journey with our innovative gym platform. Access personalized workout plans, track your progress, and stay motivated anytime, anywhere. Start building a healthier, stronger you—because your fitness goals deserve the best!</p>
                </motion.div>
                {/* {ACTIONS} */}
                <motion.div 
